...
export class Config {
  ...
  setRustUnchecked(arg1) {
    ...
    this._obj._exports['config::set-rust-unchecked'](this._obj._resource0_slab.insert(obj0.clone()), variant1_0);
  }
  setWasmtimeTracing(arg1) {
    ...
    this._obj._exports['config::set-wasmtime-tracing'](this._obj._resource0_slab.insert(obj0.clone()), variant1_0);
  }
  ...
  setWasmtimeCustomError(arg1) {
    ...
    this._obj._exports['config::set-wasmtime-custom-error'](this._obj._resource0_slab.insert(obj0.clone()), variant1_0);
  }
}
